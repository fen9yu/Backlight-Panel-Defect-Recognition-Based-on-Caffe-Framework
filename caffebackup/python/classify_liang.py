...
def main(argv):
    ...
    parser.add_argument(
        "--images_dim",
        default='64,64',#change for image
    ...
    parser.add_argument(
        "--labels_file",
        default=os.path.join(pycaffe_dir, "../result.txt"),
        help="result of test"
    )#where to put the resulted file liang
    parser.add_argument(
        "--print_results",
        action='store_true',
...
#added liang for print
    if args.print_results:
        ...
        with open(args.labels_file) as f:
            ...
            indices = (-scores).argsort()[:2]#0 and 1
            ps = labels[indices]
